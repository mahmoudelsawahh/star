...
def fileTestCompare(request):
    return render(request, 'pc/text-editor.html') 

def highlight(request):
    return render(request, 'pc/highlight.html') 
 
def toolsFiles(request):
    return render(request, 'pc/tools-files.html') 
